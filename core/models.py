...
class Organization(models.Model):
    ...
    description = models.TextField("Description/Notes", max_length=765, null=True,
                                   blank=True, help_text="Description of organization")
    ...
    create_date = models.DateTimeField(null=True, blank=True)
    edit_date = models.DateTimeField(null=True, blank=True)
    oauth_domains = ArrayField(models.CharField("OAuth Domains", max_length=255,
...
class CoreGroup(models.Model):
    ...
    organization = models.ForeignKey(Organization, blank=True, null=True,
                                     on_delete=models.CASCADE, help_text='Related Org to associate with')
...
class CoreUser(AbstractUser):
    ...
    organization = models.ForeignKey(Organization, blank=True, null=True,
                                     on_delete=models.CASCADE, help_text='Related Org to associate with')
    core_groups = models.ManyToManyField(CoreGroup, verbose_name='User groups',
...
class EmailTemplate(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,
                                     verbose_name='Organization', help_text='Related Org to associate with')
...
class LogicModule(models.Model):
    ...
    core_groups = models.ManyToManyField(CoreGroup, verbose_name='Logic Module groups',
                                         blank=True, related_name='logic_module_set', related_query_name='logic_module')
    create_date = models.DateTimeField(null=True, blank=True)
    edit_date = models.DateTimeField(null=True, blank=True)
