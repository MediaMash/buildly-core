...
COREUSER_INVITE_CHECK_RESPONSE = {200: Schema(
    type='object',
    properties={
        'email': Schema(type='string'),
        'organization': Schema(type='object', properties={
...
COREUSER_RESETPASS_RESPONSE = {200: Schema(
    type='object',
    properties={
        'detail': Schema(type='string'),
...
COREUSER_INVITE_EVENT_CHECK_RESPONSE = {200: Schema(
    ...
    properties={
        'email': Schema(type='string'),
        'room_uuid': Schema(type='number'),
        'event_uuid': Schema(type='number'),
